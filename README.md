...
* HardFault when initialising the `kernel` *FIXED* 
...
* Issue: No initial serial output on `main.ccp` on line 50 `kernel->streams->printf("Smoothie2 dev\n");` *CURRENTLY UNDER INVESTIGATION 2016-11-02*
* Issue: Movement (G0 Zn, G28 Homing) only moves a short distance then stops *CURRENTLY UNDER INVESTIGATION 2016-11-02*
